    ...
    <div className="flex flex-col justify-center bg-white min-h-screen">
      ...
      <div className="bg-white rounded-[40px] overflow-hidden mx-4 sm:mx-12 my-6 sm:my-8 lg:mx-48">
        <div className="grid md:grid-cols-1 items-center h-[40vh] border-b-2">
          <div className="bg-cyan-800 p-4 sm:p-6 md:p-12 flex flex-col justify-center items-center text-left h-full">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2">
          {teamMembers.map((member, index) => (
            <div key={member.name} className="overflow-hidden">
              ...
              <div
                className={`${member.bgColor} flex justify-center items-center p-0 
                  rounded-b-[40px] sm:rounded-none ${index === 0 ? "sm:rounded-bl-[40px]" : "sm:rounded-br-[40px]"}`}
              >
                <Image
              ...
              <div className="bg-white p-4 text-center">
                <h3 className="text-lg sm:text-2xl font-bold text-gray-900">{member.name}</h3>
